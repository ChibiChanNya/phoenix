      ...
      <div class="content-lg container">
        <div class="row">
          ...
          <div class="privacy-text">
            ...
            <p>Documento físico, electrónico o fijado en cualquier otro formato generado por el responsable que es
              puesto a disposición del titular, previo al tratamiento de sus datos personales (en lo conducente se
              utilizará como AVISO).</p>
            <h4>BASES DE DATOS</h4>
            <p>Conjunto ordenado de datos personales referentes a una persona identificada e identificable.</p>
            <h4>BLOQUEO</h4>
            <p>Identificación y conservación de datos personales una vez cumplida la finalidad para la cual fueron
              recabadas, con el único propósito de determinar posibles responsabilidades en relación con su tratamiento,
              hasta el plazo de prescripción legal o contractual de éstas.</p>
            <h4>CONSENTIMIENTO</h4>
            <p>Manifestación de la voluntad del titular de los datos personales, mediante el cual se efectúa el
              tratamiento de los mismos.</p>
            <h4>DATOS PERONALES</h4>
            <p>Cualquier información concerniente a una persona física identificada e identificable.</p>
            <h4>DATOS PERSONALES SENSIBLES</h4>
            <p>Aquellos datos personales que afecten la esfera más íntima de su titular, o cuya utilización indebida
              pueda dar origen a discriminación o conlleve un riesgo grave para éste, en particular aquellos que puedan
              revelar aspectos como origen racial o étnico, estado de salud presente y futuro, información genética,
              creencias filosóficas y morales, afiliación sindical, opiniones políticas y preferencia sexual.</p>
            <h4>DERECHOS ARCO</h4>
            <p>Derechos de acceso, rectificación, cancelación y oposición.</p>
            <h4>ENCARGADO</h4>
            <p>Persona física que sola o conjuntamente con otras trate datos personales por cuenta del responsable.</p>
            <h4>RESPONSABLE</h4>
            <p>Persona física o moral de carácter privado que decide sobre el tratamiento de datos personales.</p>
            <h4>TITULAR</h4>
            <p>Persona física a quien corresponden los datos personales.</p>
            <h4>TERCERO</h4>
            <p>Persona física o moral, nacional o extranjera, distinta del titular o del responsable de los datos.</p>
            <h4>TRATAMIENTO</h4>
            <p>Obtención, uso, divulgación o almacenamiento de datos personales, por cualquier medio. El uso abarca
              cualquier acción de acceso, manejo, aprovechamiento, transferencia o disposición de datos personales.</p>
            <h4>TRANSFERENCIA</h4>
            ...
            <p>Uso de cámaras de video fijas o móviles, con o sin sonido, o de sistemas cerrados de televisión que
            ...
            <ol>
              <li>Ofrecerle o hacerle parte de productos o servicios que cumplen con el objeto social de nuestra
                empresa.
              </li>
              <li>Ofrecerle productos o servicios que nos solicite.</li>
              <li>Cumplir con las obligaciones derivadas de la relación que se lleve a cabo con usted.</li>
              <li>Desarrollo de nuevos productos, servicios o programas directamente relacionados con nuestro objeto
                social.
              </li>
              <li>Seguimiento de nuestra relación con usted para el debido cumplimiento de nuestro objeto social.</li>
              <li>Envío de información relacionada con nuestra relación con usted y el cumplimiento de nuestro objeto
                social.
              </li>
              <li>De manera adicional, podremos utilizar su información personal con otros fines, que no estén
                directamente relacionados con nuestra relación, sino con fines de mejorar la atención y calidad de
                nuestros servicios.
              </li>
            ...
            <ol>
              ...
              <li>Registro federal de causantes (RFC).</li>
              <li>Nacionalidad.</li>
