rmodal.min.js:1: WARNING - Suspicious code. The result of the 'not' operator is not being used.
...
WARNING - Failed to resolve sourcemap at rmodal.min.js.map: rmodal.min.js.map
...
!function(a,c){"object"==typeof exports&&"undefined"!=typeof module?module.exports=c():"function"==typeof define&&define.amd?define(c):a.RModal=c()}(this,function(){var a=function(a,b){return Object.prototype.toString.call(a).toLowerCase()==="[object "+b+"]"},c=function(a,b){a.className.split(/\s+/).filter(function(a){return!!a&&a==b}).length||(a.className+=" "+b)},d=function(a,b){a.className=a.className.split(/\s+/).filter(function(a){return!!a&&a!=b}).join(" ")},b=function(a,b){var e=this;this.opened=
!1;this.opts={bodyClass:"modal-open",dialogClass:"modal-dialog",dialogOpenClass:"bounceInDown",dialogCloseClass:"bounceOutUp",focus:!0,focusElements:"a[href] area[href] input:not([disabled]):not([type=hidden]) button:not([disabled]) select:not([disabled]) textarea:not([disabled]) iframe object embed *[tabindex] *[contenteditable]".split(" "),escapeClose:!0,content:null,closeTimeout:500};Object.keys(b||{}).forEach(function(a){void 0!==b[a]&&(e.opts[a]=b[a])});this.overlay=a;this.dialog=a.querySelector("."+
this.opts.dialogClass);this.opts.content&&this.content(this.opts.content)};return b.prototype.open=function(e){var b=this;if(this.content(e),!a(this.opts.beforeOpen,"function"))return this._doOpen();this.opts.beforeOpen(function(){b._doOpen()})},b.prototype._doOpen=function(){c(document.body,this.opts.bodyClass);d(this.dialog,this.opts.dialogCloseClass);c(this.dialog,this.opts.dialogOpenClass);this.overlay.style.display="block";this.opts.focus&&(this.focusOutElement=document.activeElement,this.focus());
a(this.opts.afterOpen,"function")&&this.opts.afterOpen();this.opened=!0},b.prototype.close=function(){var b=this;if(!a(this.opts.beforeClose,"function"))return this._doClose();this.opts.beforeClose(function(){b._doClose()})},b.prototype._doClose=function(){var b=this;d(this.dialog,this.opts.dialogOpenClass);c(this.dialog,this.opts.dialogCloseClass);d(document.body,this.opts.bodyClass);this.opts.focus&&this.focus(this.focusOutElement);a(this.opts.afterClose,"function")&&this.opts.afterClose();this.opened=
!1;setTimeout(function(){b.overlay.style.display="none"},this.opts.closeTimeout)},b.prototype.content=function(a){if(void 0===a)return this.dialog.innerHTML;this.dialog.innerHTML=a},b.prototype.elements=function(b,c){return c=c||-1<window.navigator.appVersion.indexOf("MSIE 9.0"),b=a(b,"array")?b.join(","):b,[].filter.call(this.dialog.querySelectorAll(b),function(a){return c?(a=window.getComputedStyle(a),"none"!==a.display&&"hidden"!==a.visibility):null!==a.offsetParent})},b.prototype.focus=function(b){(b=
b||this.elements(this.opts.focusElements)[0]||this.dialog.firstChild)&&a(b.focus,"function")&&b.focus()},b.prototype.keydown=function(a){function b(){a.preventDefault();a.stopPropagation()}if(this.opts.escapeClose&&27==a.which&&this.close(),this.opened&&9==a.which&&this.dialog.contains(a.target)){var c=this.elements(this.opts.focusElements),d=c[0];c=c[c.length-1];d==c?b():a.target==d&&a.shiftKey?(b(),c.focus()):a.target!=c||a.shiftKey||(b(),d.focus())}},b.prototype.version="1.0.29",b.version="1.0.29",
b});
